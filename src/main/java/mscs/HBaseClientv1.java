 ...
 *
 * This is HBase client example for v1.x.
 */
package mscs;
 ...
 *    +-----------------------------------------------------+
 */
public class HBaseClientv1 {
    // Ambari -> HBase -> Configs -> Advanced -> Advanced hbase-site -> hbase.zookeeper.quorum
    private final String ZOOKEEPER_QUORUM = "zk3-kshimi.2bxm5op2wr5uxe5a5tm5dnggke.dx.internal.cloudapp.net,zk4-kshimi.2bxm5op2wr5uxe5a5tm5dnggke.dx.internal.cloudapp.net,zk0-kshimi.2bxm5op2wr5uxe5a5tm5dnggke.dx.internal.cloudapp.net";
    ...
    public static void main(String[] args) throws IOException {
        ...
        HBaseClientv1 hc = new HBaseClientv1();
        hc.setUp();
